...
export const aiRouter = new Hono()
...
}), validator("query", z.object({ organizationId: z.string().optional() }).optional()), async (c) => {
...
}), validator("json", z.object({ title: z.string().optional() })), async (c) => {
    const { id } = c.req.param();
    ...
    .post("/chats/:id/messages", describeRoute({
    tags: ["AI"],
    summary: "Add message to chat",
    description: "Send all messages of the chat to the AI model to get a response",
    responses: {
        200: {
