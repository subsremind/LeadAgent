...
export const newsletterRouter = new Hono().basePath("/newsletter").post("/signup", localeMiddleware, validator("form", z.object({
    ...
    try {
        ...
        logger.error("newsletterRouter sendEmail", error);
