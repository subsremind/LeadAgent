...
export const agentSettingRouter = new Hono()
    ...
    .post("/generate-prompt", validator("json", z.object({
    ...
    .post("/", validator("json", AgentSettingCreateInput), describeRoute({
    ...
    .put("/:id", validator("json", AgentSettingCreateInput), describeRoute({
