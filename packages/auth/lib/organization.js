...
export async function updateSeatsInOrganizationSubscription(organizationId) {
    ...
    const activeSubscription = organization.purchases.find((purchase) => purchase.type === "SUBSCRIPTION");
