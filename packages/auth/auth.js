...
import { admin, createAuthMiddleware, magicLink, openAPI, organization, username, } from "better-auth/plugins";
...
const getLocaleFromRequest = (request) => {
    ...
    return (cookies[config.i18n.localeCookieName] ??
...
export const auth = betterAuth({
    ...
    user: {
        ...
        changeEmail: {
            enabled: true,
            sendChangeEmailVerification: async ({ user: { email, name }, url }, request) => {
