...
export function CustomerPortalButton({ purchaseId }) {
    ...
    const createCustomerPortal = async () => {
        try {
            ...
            toast.error(t("settings.billing.createCustomerPortal.notifications.error.title"));
        }
    };
    return (<Button variant="outline" size="sm" onClick={() => createCustomerPortal()} loading={createCustomerPortalMutation.isPending}>
