...
export function CropImageDialog({ image, open, onOpenChange, onCrop, }) {
    ...
    return (<Dialog open={open} onOpenChange={onOpenChange}>
			<DialogContent>
				...
				<div>
					{imageSrc && (<Cropper src={imageSrc} style={{ width: "100%" }} initialAspectRatio={1} aspectRatio={1} guides={true} ref={cropperRef}/>)}
				</div>
				<DialogFooter>
