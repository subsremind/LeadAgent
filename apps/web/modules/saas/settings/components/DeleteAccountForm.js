...
export function DeleteAccountForm() {
    ...
    return (<>
			<SettingsItem danger title={t("settings.account.deleteAccount.title")} description={t("settings.account.deleteAccount.description")}>
			...
			<AlertDialog open={showConfirmation} onOpenChange={(open) => setShowConfirmation(open)}>
				<AlertDialogContent>
					...
					<AlertDialogFooter>
						...
						<Button variant="error" loading={deleting} onClick={async () => {
            await onDelete();
