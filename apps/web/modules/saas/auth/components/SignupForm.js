...
import { AlertTriangleIcon, ArrowRightIcon, EyeIcon, EyeOffIcon, MailboxIcon, } from "lucide-react";
...
export function SignupForm({ prefillEmail }) {
    ...
    return (<div>
			...
			{form.formState.isSubmitSuccessful && !invitationOnlyMode ? (<Alert variant="success">
					...
					<Form {...form}>
						<form className="flex flex-col items-stretch gap-4" onSubmit={form.handleSubmit(onSubmit)}>
							{form.formState.isSubmitted &&
                form.formState.errors.root && (<Alert variant="error">
                    ...
                    ? "text"
                    : "password"} className="pr-10" {...field} autoComplete="new-password"/>
