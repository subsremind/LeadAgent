...
export function InviteMemberForm({ organizationId, }) {
    ...
    const onSubmit = async (values) => {
        try {
            ...
            toast.error(t("organizations.settings.members.inviteMember.notifications.error.title"));
        }
    };
    return (<SettingsItem title={t("organizations.settings.members.inviteMember.title")} description={t("organizations.settings.members.inviteMember.description")}>
			<Form {...form}>
