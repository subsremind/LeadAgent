...
export function DeleteOrganizationForm() {
    ...
    const handleDelete = async () => {
        confirm({
            ...
            onConfirm: async () => {
                ...
                if (error) {
                    toast.error(t("organizations.settings.notifications.organizationNotDeleted"));
                    return;
                }
                toast.success(t("organizations.settings.notifications.organizationDeleted"));
    ...
    return (<>
			<SettingsItem danger title={t("organizations.settings.deleteOrganization.title")} description={t("organizations.settings.deleteOrganization.description")}>
