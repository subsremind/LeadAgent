...
export function AdminSetting() {
    ...
    return (<SettingsList>
			<SettingsItem title={t("admin.setting.reddit.title")} description={t("admin.setting.reddit.description")}>
				<Card className="p-6">
					<RedditAuth />
				</Card>
			</SettingsItem>
			<SettingsItem title={t("admin.setting.credit_title")} description={t("admin.setting.credit_description")}>
