...
import { adminOrganizationsQueryKey, useAdminOrganizationsQuery, } from "@saas/admin/lib/api";
...
export function OrganizationList() {
    ...
    const columns = useMemo(() => [
        {
            ...
            cell: ({ row: { original: { id, name, logo, _count: { members: membersCount }, }, }, }) => (<div className="flex items-center gap-2">
						<OrganizationLogo name={name} logoUrl={logo}/>
						<div className="leading-tight">
							<Link href={getOrganizationEditPath(id)} className="block font-bold">
								{name}
							</Link>
							<small>
    ...
    return (<Card className="p-6">
			...
			<Input type="search" placeholder={t("admin.organizations.search")} value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} className="mb-4"/>
